...
const bakuCVTasks = [
  {
    ...
    acceptanceCriteria: "Dokumen rencana Customer Validation lengkap dengan hipotesis PSF, profil responden, dan metodologi pengujian yang disepakati tim.",
  ...
  },
  {
    ...
    acceptanceCriteria: "Dokumen kesepakatan keputusan fase CV (Fit / Iterasi / Pivot) yang ditandatangani/disetujui.",
    tahap: "customer_validation" as const,
  },
];
