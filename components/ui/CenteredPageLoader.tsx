...
export function CenteredPageLoader({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center pointer-events-none bg-transparent animate-in fade-in duration-150">
      <div className="bg-white px-7 py-6 rounded-2xl shadow-2xl border border-gray-200/90 flex flex-col items-center justify-center gap-3.5 min-w-[200px] pointer-events-none select-none animate-in zoom-in-95 duration-150">
